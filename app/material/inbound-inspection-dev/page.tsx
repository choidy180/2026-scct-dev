...
import WarehouseBoard from '@/components/wearable-warehouse-board-dev';
import { 
                    ...
                    {isVehicleDataLoaded && vehicleInfo ? (
                      <>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', padding: '0 8px' }}>
                          <InfoRow><span className="label">공급업체</span><span className="value highlight-box">세진공업 (주)</span></InfoRow>
                          <InfoRow><span className="label">도착시간</span><span className="value">10:20</span></InfoRow>
                          <InfoRow>
                              <span className="label">체류시간</span>
                              <DwellTimeBadge $isWarning={false}>11분</DwellTimeBadge>
                          </InfoRow>
                        </div>
                      </>
                    ) : (
