...
const METRIC_CONFIG = [
  { key: 'R액 압력', label: 'R액 압력', unit: 'bar', icon: <FiActivity /> },
  { key: 'P액 압력', label: 'P액 압력', unit: 'bar', icon: <FiActivity /> },
  { key: 'R액 탱크온도', label: 'R액 탱크온도', unit: '℃', icon: <FiThermometer /> },
  { key: 'P액 탱크온도', label: 'P액 탱크온도', unit: '℃', icon: <FiThermometer /> },
  { key: 'R액 헤드온도', label: 'R액 헤드온도', unit: '℃', icon: <FiThermometer /> },
  { key: 'P액 헤드온도', label: 'P액 헤드온도', unit: '℃', icon: <FiThermometer /> },
  { key: '온조#1 리턴온도', label: '온조#1 리턴온도', unit: '℃', icon: <FiThermometer /> },
  { key: '온조#2 리턴온도', label: '온조#2 리턴온도', unit: '℃', icon: <FiThermometer /> },
  { key: '온조#1 공급수압력', label: '온조#1 공급수압력', unit: 'bar', icon: <FiActivity /> },
  { key: '온조#2 공급수압력', label: '온조#2 공급수압력', unit: 'bar', icon: <FiActivity /> },
];
...
const MOCK_API_RESPONSE: ApiResponse = {
  ...
  data: [
    { 
      "time_diff": -31759, "Serial No.": "WO2601140002200000", "Model No.": "ADC30021006", "지그번호": "DJ24R2G90005", "대차번호": "1", 
      "R액 압력": "150.5", "P액 압력": "148.2", 
      "R액 탱크온도": "25.5", "P액 탱크온도": "26.1", 
      "R액 헤드온도": "28.0", "P액 헤드온도": "28.5", 
      "온조#1 리턴온도": "22.0", "온조#2 리턴온도": "22.3", 
      "온조#1 공급수압력": "4.5", "온조#2 공급수압력": "4.4" 
    },
    { 
      "time_diff": -31779, "Serial No.": "WO2601140001800000", "Model No.": "ADC30008834", "지그번호": "DJ20MRH90013", "대차번호": "2", 
      "R액 압력": "151.0", "P액 압력": "149.0", 
      "R액 탱크온도": "25.3", "P액 탱크온도": "26.0", 
      "R액 헤드온도": "28.1", "P액 헤드온도": "28.4", 
      "온조#1 리턴온도": "21.8", "온조#2 리턴온도": "22.1", 
      "온조#1 공급수압력": "4.6", "온조#2 공급수압력": "4.5" 
    },
    { 
      "time_diff": -31800, "Serial No.": "WO2601140001800000", "Model No.": "ADC30008834", "지그번호": "DJ20MRH90008", "대차번호": "3", 
      "R액 압력": "150.2", "P액 압력": "148.8", 
      "R액 탱크온도": "31.5", "P액 탱크온도": "26.2", // R액 탱크온도 높음(주의)
      "R액 헤드온도": "27.9", "P액 헤드온도": "28.3", 
      "온조#1 리턴온도": "22.2", "온조#2 리턴온도": "22.4", 
      "온조#1 공급수압력": "4.4", "온조#2 공급수압력": "4.3" 
    },
    { 
      "time_diff": -31820, "Serial No.": "WO2601140001800000", "Model No.": "ADC30008834", "지그번호": "DJ20MRH90006", "대차번호": "4", 
      "R액 압력": "145.0", "P액 압력": "144.5", 
      "R액 탱크온도": "25.4", "P액 탱크온도": "25.9", 
      "R액 헤드온도": "28.2", "P액 헤드온도": "28.6", 
      "온조#1 리턴온도": "22.1", "온조#2 리턴온도": "22.2", 
      "온조#1 공급수압력": "2.1", "온조#2 공급수압력": "4.5" // 온조#1 수압 낮음(에러)
    },
    { 
      "time_diff": -31839, "Serial No.": "WO2601140001800000", "Model No.": "ADC30008834", "지그번호": "DJ24R2G90004", "대차번호": "5", 
      "R액 압력": "152.1", "P액 압력": "150.3", 
      "R액 탱크온도": "25.6", "P액 탱크온도": "26.1", 
      "R액 헤드온도": "28.0", "P액 헤드온도": "28.5", 
      "온조#1 리턴온도": "22.0", "온조#2 리턴온도": "22.3", 
      "온조#1 공급수압력": "4.5", "온조#2 공급수압력": "4.6" 
    },
  ],
  "DX_LIMIT_LIST": [
    ...
    { "name": "온조#1 리턴온도", "min": "15", "max": "30" },
    { "name": "온조#2 리턴온도", "min": "15", "max": "30" },
    { "name": "온조#1 공급수압력", "min": "3.0", "max": "6.0" },
    { "name": "온조#2 공급수압력", "min": "3.0", "max": "6.0" }
  ]
};
